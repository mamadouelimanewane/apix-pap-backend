...
const papsData = [
  ...
  { nom: 'Fall', prelem: 'Awa', email: 'awa.fall@example.sn', telephone: '+221780123456', adresse: 'Fann, Dakar' }
];
...
async function seed() {
  try {
    ...
    console.log(`✅ Created ${paps.length} PAPs`);
    ...
    console.log(`✅ Created ${biens.length} Biens`);
    ...
    console.log(`✅ Created ${compensations.length} Compensations`);
    ...
    // Summary - skip Reclamations as model may not exist
    console.log('⚠️  Skipping Reclamations (to implement later)');

    // Summary
    console.log('\n📊 ===== SEED COMPLETE =====');
    console.log(`👥 PAPs: ${paps.length}`);
